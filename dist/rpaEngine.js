...
dotenv.config();
const storage = {
    updateRpaTask: async (id, update) => {
        console.log(`[storage] updateRpaTask(${id}):`, update);
    },
    createAutomationLog: async (log) => {
...
const getInputByLabel = async (page, labelText) => {
...
const performLogin = async (page, username, password, taskId) => {
